    ...
    const analyzers = [
        {
            ...
            checks: [
                ...
                },
                {
                    ...
                    description: () => <>Проверка домена и IP-адреса по глобальным черным спискам (например, <a href="https://www.spamhaus.org/" target="_blank" rel="noopener noreferrer" className="font-semibold text-indigo-500 dark:text-indigo-400 hover:underline">Spamhaus</a>).</>,
                },
            ]
        },
        {
...
const EmailSafetyPipelineDocumentationPage: React.FC = () => {
    ...
    const workflowStages = [
        ...
        },
        {
            ...
            title: "3. Финальное решение (Final Verdict)",
