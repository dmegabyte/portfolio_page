...
const GptAssistantReportPage: React.FC = () => {
        ...
        { 
            ...
            content: (
                <div className="space-y-6 text-base leading-relaxed">
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Задача</h4>
                        <p className="text-slate-700 dark:text-slate-300">Проверить жизнеспособность RAG-архитектуры на реальных данных.</p>
                    </div>
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Действие</h4>
                        <p className="text-slate-700 dark:text-slate-300">Сформирована начальная база знаний путем автоматической обработки ~800 диалогов. Запущен MVP.</p>
                    </div>
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Результат</h4>
                        <p className="text-slate-700 dark:text-slate-300">Достигнута автоматизация 22% запросов, однако качественные метрики (Точность: 5.0, Стилистика: 4.1) оказались низкими.</p>
                    </div>
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Вывод</h4>
                        <p className="text-slate-700 dark:text-slate-300">Гипотеза подтверждена — RAG-подход работает. Однако стало очевидно, что качество ответов напрямую зависит от чистоты и структурированности данных в базе знаний.</p>
                    </div>
                </div>
            )
        },
        { 
            ...
            content: (
                 <div className="space-y-6 text-base leading-relaxed">
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Задача</h4>
                        <p className="text-slate-700 dark:text-slate-300">Повысить доверие операторов к системе, отсекая заведомо некачественные ответы.</p>
                    </div>
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Действие</h4>
                        <p className="text-slate-700 dark:text-slate-300">Внедрена метрика уверенности (`score`). Ответы с `score &lt; 80` перестали предлагаться оператору.</p>
                    </div>
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Результат</h4>
                        <p className="text-slate-700 dark:text-slate-300">Уровень автоматизации ожидаемо снизился до 12%, так как система стала более "осторожной". Качество оставшихся подсказок повысилось.</p>
                    </div>
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Вывод</h4>
                        <p className="text-slate-700 dark:text-slate-300">Жертва количественных показателей ради качества оказалась оправданной. Это позволило перейти от "генерации любого ответа" к "предоставлению только надежных подсказок".</p>
                    </div>
                </div>
            )
        },
        { 
            ...
            content: (
                <div className="space-y-6 text-base leading-relaxed">
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Задача</h4>
                        <p className="text-slate-700 dark:text-slate-300">Снизить стоимость обработки одного тикета без потери качества.</p>
                    </div>
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Действие</h4>
                        <p className="text-slate-700 dark:text-slate-300">Разработан алгоритм предобработки, который очищал входящие запросы от HTML-разметки и другого "шума" перед отправкой в модель.</p>
                    </div>
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Результат</h4>
                        <p className="text-slate-700 dark:text-slate-300">Себестоимость запроса снизилась почти в 3 раза (с 12 ₽ до 4.5 ₽). Качество ответов выросло (Точность +1.74), так как модель получала более релевантные данные.</p>
                    </div>
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Вывод</h4>
                        <p className="text-slate-700 dark:text-slate-300">Фокус на качестве входящих данных (Data-Centric AI) оказался более эффективной стратегией, чем использование дорогих моделей для обработки "грязных" данных.</p>
                    </div>
                </div>
            )
        },
        { 
            ...
            content: (
                <div className="space-y-6 text-base leading-relaxed">
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Задача</h4>
                        <p className="text-slate-700 dark:text-slate-300">Упростить архитектуру и повысить предсказуемость, сохранив качество.</p>
                    </div>
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Действие</h4>
                        <p className="text-slate-700 dark:text-slate-300">Вся логика перенесена на одну модель — Gemini 2.5 Pro, которая выполняет RAG-поиск и генерацию в рамках одного запроса.</p>
                    </div>
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Результат</h4>
                        <p className="text-slate-700 dark:text-slate-300">Себестоимость одного тикета снизилась до <b>3 ₽</b>. Точность выросла до <b>7.9</b> (▲ +1.3), а уровень автоматизации достиг <b>35%</b>.</p>
                    </div>
                    <div>
                        <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Вывод</h4>
                        <p className="text-slate-700 dark:text-slate-300">Единая, более мощная модель оказалась эффективнее каскада из нескольких моделей. Система стала быстрее, а её поведение — прозрачнее благодаря полным логам рассуждений.</p>
                    </div>
                </div>
            )
        }
    ...
    const chartConfig = {
        ...
        yKeys: [
            ...
            { key: 'Стоимость', color: '#F472B6', label: 'Стоимость (₽)', axis: 'right' as const }
        ],
