  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl p-6 sm:p-8 lg:p-12 animate-fade-in border border-gray-200 dark:border-slate-700">
      ...
      <div className="max-w-4xl mx-auto text-slate-700 dark:text-slate-300 space-y-6">
        ...
        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-200 pt-6 border-t border-gray-200 dark:border-slate-700 mt-8">Ключевые компетенции и стек</h2>
