...
import { 
    ...
    ShieldExclamationIcon, WrenchScrewdriverIcon, PlayIcon, ChartBarIcon, ShieldCheckIcon, BeakerIcon, InformationCircleIcon
    ...
    const modules = [
        {
            ...
            description: 'Централизованная обработка и логирование ошибок.',
            Icon: ShieldExclamationIcon
        },
        {
            name: '02_Utils.js',
            description: 'Набор вспомогательных функций для работы с текстом, датами и данными.',
            Icon: WrenchScrewdriverIcon
        },
        {
            name: '03_GptApi.js',
            description: 'Управление взаимодействием с моделями Gemini и GPT.',
            Icon: CpuChipIcon
        },
        {
            name: '04_Omnidesk.js',
            description: 'Интеграция с API тикет-системы Omnidesk для получения и обновления тикетов.',
            Icon: ChatBubbleLeftRightIcon
        },
        {
            name: '05_Triggers.js',
            description: 'Управление триггерами и запуск автоматизированных задач по расписанию.',
            Icon: PlayIcon
        },
        {
            name: '06_History.js',
            description: 'Хранение и управление историей обращений клиентов для контекстного анализа.',
            Icon: ClockIcon
        },
        {
            name: '07_ReportGenerator.js',
            description: 'Формирование аналитических отчётов по эффективности системы.',
            Icon: ChartBarIcon
        },
        {
            name: '08_UrlValidator.js',
            description: 'Проверка всех ссылок в тикетах на безопасность и доступность.',
            Icon: LinkIcon
        },
        {
            name: '10_AdvancedSpamFilter.js',
            description: 'Продвинутая фильтрация спама и нерелевантных обращений.',
            Icon: ShieldCheckIcon
        },
        {
            name: '12_PlaygroundTester.js',
            description: 'Инструменты для тестирования и отладки новых гипотез и промтов.',
            Icon: BeakerIcon
        },
        {
            name: 'CONFIG.js',
            description: 'Центральный файл конфигурации с параметрами системы и ключами API.',
            Icon: Cog6ToothIcon
        }
    ];
      ...
      <div className="space-y-16">
        ...
        <section id="modules" className="scroll-mt-24">
            <SectionHeader 
                ...
                title="7. Модули и их ответственность"
                subtitle="Архитектурная схема старой версии проекта, показывающая распределение логики по файлам. Этот графический элемент восстанавливает утерянную информацию о структуре."
            />
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 not-prose">
                {modules.map((module) => (
                    <div 
                        key={module.name} 
                        className="group flex flex-col p-6 bg-white dark:bg-slate-800/50 rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-200 dark:border-slate-700 hover:border-indigo-400 dark:hover:border-indigo-500"
                    >
                        <div className="flex items-center gap-4 mb-4">
                            <div className="flex-shrink-0 w-12 h-12 bg-gray-100 dark:bg-slate-700 rounded-lg flex items-center justify-center">
                                <module.Icon className="w-7 h-7 text-gray-500 dark:text-slate-400 group-hover:text-indigo-500 dark:group-hover:text-indigo-400 transition-colors" aria-hidden="true" />
                            </div>
                            <h4 className="font-bold text-lg text-slate-800 dark:text-slate-200 leading-tight break-all">
                                {module.name}
                            </h4>
                        </div>
